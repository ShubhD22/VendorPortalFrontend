    ...
    <div class="py-2 px-6 bg-[#f8f4f3] flex items-center shadow-md shadow-black/5 sticky top-0 left-0 z-30">
      ...
      <ul class="ml-auto flex items-center">
        <li class="mr-1 dropdown">
          ...
          {isSearchVisible && (
            <div className="absolute right-20 dropdown-menu shadow-md shadow-black/5 z-30 max-w-xs w-full bg-white rounded-md border border-gray-100">
        ...
        <li class="dropdown">
          ...
          {isNotiVisible && (
            <div class="dropdown-menu absolute right-10 shadow-md shadow-black/5 z-30 max-w-xs w-full bg-white rounded-md border border-gray-100">
